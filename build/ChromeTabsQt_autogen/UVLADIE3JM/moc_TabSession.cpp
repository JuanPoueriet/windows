...
namespace {
struct qt_meta_tag_ZN10TabSessionE_t {};
} // unnamed namespace

template <> constexpr inline auto TabSession::qt_create_metaobjectdata<qt_meta_tag_ZN10TabSessionE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<TabSession, qt_meta_tag_ZN10TabSessionE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject TabSession::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10TabSessionE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10TabSessionE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10TabSessionE_t>.metaTypes,
    nullptr
} };
...
void TabSession::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TabSession::*)(const QString & )>(_a, &TabSession::titleChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TabSession::*)(const QIcon & )>(_a, &TabSession::iconChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (TabSession::*)(bool )>(_a, &TabSession::dirtyChanged, 2))
            return;
    }
}
...
void *TabSession::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10TabSessionE_t>.strings))
